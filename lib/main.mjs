...
async function requireRepository(repositoryDir) {
  const required = ['.git', 'bin/session-memory.mjs', 'lib/main.mjs', 'skills/session-memory/SKILL.md', 'CLAUDE.md'];
...
async function install(repositoryDir, paths, options) {
  ...
  installNative(repositoryDir, paths, { projectDir: resolveProjectDir(options), dryRun: options['dry-run'] });
