import { cleanRealUserText } from './user-text.mjs';
...
export function parseClaudeTranscript(lines) {
  ...
  for (const line of lines) {
    ...
    if (o.type === 'user' && o.message && o.message.role === 'user') {
      ...
      const realText = o.isMeta || o.sourceToolUseID ? null : cleanRealUserText(text);
      if (realText) {
        r.turns += 1;
        if (!r.first_prompt) r.first_prompt = realText;
      }
    }
