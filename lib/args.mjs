...
const VALUE_OPTIONS = ['repo-url', 'repo-dir', 'project-dir', 'dir', 'cwd', 'repo', 'days', 'ids', 'targets', 'projects-dir', 'sessions-dir', 'desktop-sessions-dir'];
...
export const HELP = `Usage:
  ...
  session-memory install [--repo-dir <path>] [--project-dir <path>] [--dry-run]
